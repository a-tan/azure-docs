...
Entries in the ACLs are stored as GUIDs that corresponds to users in Azure Active Directory (AAD). The Azure Portal makes ACLs easier to use by translating the GUIDs into friendly names when possible. 
